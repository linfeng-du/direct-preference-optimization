...
def collate_fn(batch, tokenizer, max_length, device):
    ...
    prompt_mask = prompt_ids.shape[1]
    labels_prefered = prompt_prefered_ids.clone()

    labels_prefered[:,:prompt_mask] = -100 
    
    
    labels_disprefered = prompt_disprefered_ids.clone()
    labels_disprefered[:,:prompt_mask] = -100
    ...
    return {'uids': uids,
            ...
            'labels_prefered': labels_prefered,
            'labels_disprefered': labels_disprefered}
